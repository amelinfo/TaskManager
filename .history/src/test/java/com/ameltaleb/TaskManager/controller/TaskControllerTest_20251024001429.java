...
public class TaskControllerTest {
    ...
    @Test
    void testUpdateTask_200() throws Exception {
        Task taskToUpdate = new Task(EXISTING_TASK_ID,"task to update", "Task to be updated successfully", Status.)
        // Given
        doNothing().when(taskService).updateTask(EXISTING_TASK_ID, new Task(EXISTING_TASK_ID,))
    }
}
