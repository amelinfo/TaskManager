...
public class TaskControllerTest {
    ...
    void testDeleteTask_404() throws Exception {
        Task taskToDelete = new Task(NON_EXISTING_TASK_ID,"task to delete", "non existant task to delete",Status.CANCELLED);
        mockMvc.perform(delete("/api/tasks/id", taskToDelete))
            .contentType(MediaType.APP)
