...
public class TaskControllerTest {
    ...
    @Test
    void testUpdateTask_404() throws Exception {
        Task updatedTask = new Task(NON_EXISTING_TASK_ID, "Updated Task", "Updated Description", TaskStatus.COMPLETED, null);
        
        when(taskService.updateTask(eq(NON_EXISTING_TASK_ID), any(Task.class)))
                .thenThrow(new TaskNotFoundException(NON_EXISTING_TASK_ID));
