...
public class TaskControllerTest {
    ...
    void testGetAllTasks_200() throws Exception {
        ...
        when(taskService.getAllTasks()).thenReturn(java.util.List.of(
            new Task(UUID.fromString("122222-25555-56665-12313"),"Task 1", "Desc 1", Status.PENDING),
            new Task(UUID.fromString(14122-555565-78798-33333"),"Task 2", "Desc 2", Status.COMPLETED)
        ));
